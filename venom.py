...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/jack_sparrow_offical_0", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Contact admin @jack_sparrow_offical*", parse_mode='Markdown')
    else:
